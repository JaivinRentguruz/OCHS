...
import com.ochs.app.flexiicar_app.user.Fragment_Agreements;
...
import static com.ochs.app.apicall.ApiEndPoint.CURRENT_BOOKING_LIST;
                                    ...
                                    public void onClick(View v) {
                                     /*   Intent i = new Intent(getContext(), Booking_Activity.class);
                                        ...
                                        NavHostFragment.findNavController(Fragment_CurrentBooking.this)
                                                .navigate(R.id.action_BookingList_to_LocationAndKey);
